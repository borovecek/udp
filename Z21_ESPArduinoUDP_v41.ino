...
Changelog:
      ...
      02.05.2024 fix "Fremdzentrale" for App usage
*/ 
...
// Set your new MAC Address ("Modelleisenb_03:e7:91")
uint8_t newMACAddress1[] = {0x84, 0x2b, 0xbc, 0x03, 0xe7, 0x91};
uint8_t newMACAddress2[] = {0x84, 0x2b, 0xbc, 0x03, 0xe7, 0x92};
...
void setup()
{
  ...
  wifi_set_macaddr(SOFTAP_IF, &newMACAddress1[0]);
  // For Station Mode
  wifi_set_macaddr(STATION_IF, &newMACAddress2[0]);
